...
<footer class="bg-gray-800" aria-labelledby="footer-heading">
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
            ...
            <div class="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    ...
                    <div class="mt-12 md:mt-0">
                        <h3 class="text-sm font-semibold text-gray-400 tracking-wider uppercase">Pagina's</h3>
                        <ul role="list" class="mt-4 space-y-4">
                            <li>
                                <a href="#" class="text-base text-gray-300 hover:text-white"> Home </a>
                            </li>

                            <li>
                                <a href="{{ route('login.index') }}" class="text-base text-gray-300 hover:text-white"> Login </a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="mt-12 border-t border-gray-200 pt-8">
            <p class="text-base text-gray-300 xl:text-center">&copy; {{ now()->format('Y') }} <a href="https://casfreriks.nl" class="text-gray-300 hover:text-white">Cas Freriks</a>. All rights reserved.</p>
        </div>
    </div>
</footer>
